    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
              <a class="nav-link" href="StandardReg.php">Register</a>
          </li>
...
<?php
   ...
   session_start();
    ...
    if (isset($_POST['username'])) {
        ...
        $query    = "SELECT * FROM `StrdUsers` WHERE Name='$username'
...
$_SESSION['user_email'] = $row['Email'];
          ...
          header("Location: StrdDashboard.php");
...
?>
    ...
    <form class="text" method="post" name="login">
        ...
        <input type="password" class="form-control" name="password" placeholder="Password"/>
         ...
         <a href="StandardReg.php"><input type="" name="button" value="Register" class="btn btn-primary btn-block mb-4" style="color:yellowgreen"></a>
