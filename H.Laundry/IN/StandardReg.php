      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="StandardLog.php">Login</a></li>
...
<?php
	...
	$mobile = mysqli_real_escape_string($conn, $_POST['Phone']);
        ...
        $query    = "INSERT into `StrdUsers` (Name, Phone, Email, Password, create_datetime)
                     VALUES ('$username', '".$mobile."', '$email','" . md5($password) . "','$create_datetime')";
        $result   = mysqli_query($conn, $query);
        if ($result) {
            echo "<div class='form'>
                  <h3>You are registered successfully.</h3><br/>
                  <p class='link'>Click here to <a href='StandardLog.php'>Login</a></p>
                  </div>";
        } else {
            echo "<div class='form'>
                  <h3>Required fields are missing.</h3><br/>
                  <p class='link'>Click here to <a href='StandardReg.php'>registration</a> again.</p>
                  </div>";
        }
    } else {
?>
    ...
    <form class="text" action="" method="post">
        ...
        <a href="StandardLog.php"><input type="" name="button" value="Login" class="btn btn-primary btn-block mb-4"></a>
    </form>
    </div>
<?php
    }
